            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Món ăn</h3>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="session/add/add_recipe.php" enctype="multipart/form-data">
                            <!-- Tên món ăn -->
                                ...
                                <div id="ingredients-container">
                                    <div class="ingredient-row d-flex align-items-center mb-3">
                                        <div class="form-group mr-3">
                                            <label for="ingredient_0">Tên nguyên liệu:</label>
                                            <select class="form-control" name="ingredients[0][id]" required>
                            ...
                            <div class="form-group">
                                ...
                                <div id="meals-container">
                                    <div class="meal-row d-flex align-items-center mb-3">
                                        <div class="form-group mr-3">
                                            <label for="meal_0">Tên bữa ăn:</label>
                                            <select class="form-control" name="meals[0][id]" required>
